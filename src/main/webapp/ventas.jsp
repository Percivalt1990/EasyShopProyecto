...
<body>
    ...
    <div class="contenido"> 
        ...
        <div class="ventas">
            <div class="boton" name="venta"><a href="${pageContext.request.contextPath}/nuevaVenta.jsp">Nueva venta</a></div>
            <div class="boton" name="gasto"><a href="${pageContext.request.contextPath}/nuevaCompra.jsp">Nueva compra</a></div>
        </div>
    </div>
</body>
</html>
